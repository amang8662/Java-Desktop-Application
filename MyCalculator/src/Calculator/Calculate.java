...
public class Calculate extends javax.swing.JFrame {
    ...
    private String ans;
    private final java.text.DecimalFormat df2 = new java.text.DecimalFormat("#.##");
    /**
    ...
    private void initComponents() {
        ...
        jButton4.setPreferredSize(new java.awt.Dimension(41, 27));
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
       ...
       num=num*(-1);
       jTextField1.setText(String.valueOf(df2.format(num)));
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        ...
        if(op=='+')
        {
           ...
           ans=String.format(df2.format(result));
